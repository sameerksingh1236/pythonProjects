...
def take_bet():
    while True:
        try:
            ...
            elif player_chips.bet < 20:
                print("Sorry, minimum bet is 20")
            else:
                break
...
if __name__ == '__main__':
    ...
    print('Welcome to BlackJack! Get as close to 21 as you can without going over!\n\
            Dealer hits until reach 17. Aces count as 1 or 11.')

    # Set up the Player's chips, remember the default value is 100
    player_chips = Chips()
    ...
    while True:
        ...
        # Show player their total chips
        print("\nPlayer's winnings stand at", player_chips.total)

        # Ask to play again if chips available
